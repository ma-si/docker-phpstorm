...
RUN useradd -m -s /bin/bash developer \
    && mkdir /home/developer/.PhpStorm-2016.1 \
    && touch /home/developer/.PhpStorm-2016.1/.keep \
    && chown -R developer.developer /home/developer \
    && mkdir /opt/phpstorm \
    && wget -O - https://download.jetbrains.com/webide/PhpStorm-2016.1.tar.gz | tar xzf - --strip-components=1 -C "/opt/phpstorm"
...
USER developer
VOLUME /home/developer/.PhpStorm-2016.1
